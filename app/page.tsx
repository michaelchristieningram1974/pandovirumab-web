...
async function getFeaturedFaqs() {
  return client.fetch(`*[_type == "patientFaq" && featured == true] | order(order asc)[0...3]{
    question,
    answer
  }`)
}
...
async function getFeaturedTestimonial() {
  return client.fetch(`*[_type == "testimonial" && featured == true][0]{
    name,
    credentials,
    quote,
    type
...
export default async function Home() {
  ...
  return (
    <main>
      ...
      {/* HERO */}
      <section style={{
        background: 'linear-gradient(135deg, #0a1628 60%, #003087 100%)',
        padding: '120px 40px',
        color: 'white',
        position: 'relative',
        overflow: 'hidden',
      ...
      <section style={{ background: '#0000CC', padding: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', textAlign: 'center' }}>
          {[
            ...
            <div key={i}>
              <p style={{ color: '#00C896', fontSize: '2.5rem', fontWeight: '900', fontFamily: 'Georgia, serif', margin: '0 0 8px' }}>
                {item.stat}
              </p>
      ...
      {/* WHAT IS PANDOZAB */}
      <section style={{ background: '#FFFFFF', padding: '100px 40px', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#555', lineHeight: '1.9', fontSize: '1.05rem', marginBottom: '16px', textAlign: 'left' }}>
          ...
          <p style={{ color: '#555', lineHeight: '1.9', fontSize: '1.05rem', marginBottom: '40px', textAlign: 'left' }}>
      ...
      <section style={{ background: '#F5F5F5', padding: '100px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#888', fontSize: '1rem', marginBottom: '60px', lineHeight: '1.7', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px' }}>
            {[
              ...
              <div key={i} style={{ background: 'white', padding: '36px', borderRadius: '12px' }}>
                <div style={{ color: '#00C896', fontSize: '2.5rem', fontWeight: '900', marginBottom: '16px', fontFamily: 'Georgia, serif' }}>
                  {item.step}
                </div>
                <h3 style={{ color: '#0a1628', fontSize: '1.1rem', fontWeight: '700', marginBottom: '12px' }}>
                  {item.title}
                </h3>
      ...
      <section style={{ background: '#0a1628', padding: '100px 40px', color: 'white' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '1rem', marginBottom: '60px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '32px' }}>
            {product?.keyFeatures?.map((feature: any, index: number) => (
              <div key={index} style={{ borderTop: '3px solid #00C896', paddingTop: '24px' }}>
                <h3 style={{ color: 'white', marginBottom: '12px', fontSize: '1.1rem', fontWeight: '700' }}>
                  {feature.title}
                </h3>
      ...
      <section style={{ background: '#FFFFFF', padding: '100px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#888', fontSize: '1rem', marginBottom: '60px', textAlign: 'center' }}>
      ...
      {faqs.length > 0 && (
        <section style={{ background: '#F5F5F5', padding: '100px 40px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{ color: '#888', fontSize: '1rem', marginBottom: '48px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              {faqs.map((faq: any, i: number) => (
                <div key={i} style={{
                  ...
                  <h3 style={{ color: '#0a1628', fontSize: '1.05rem', fontWeight: '700', marginBottom: '12px' }}>
                    {faq.question}
                  </h3>
      ...
      {testimonial && (
        <section style={{ background: '#0a1628', padding: '100px 40px', color: 'white' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.95rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
      ...
      <section style={{ background: '#00C896', padding: '80px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '40px' }}>
          <div>
            <p style={{ fontSize: '0.8rem', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '12px', color: 'rgba(10,22,40,0.6)' }}>
              Healthcare Professionals
            </p>
            <h2 style={{ fontSize: '2rem', fontWeight: '900', marginBottom: '16px', color: '#0a1628', textTransform: 'uppercase' }}>
